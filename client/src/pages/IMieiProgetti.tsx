            ...
            <div className="flex gap-2">
              ...
              {project.caseStudyUrl && (
                <Button size="sm" variant="default" asChild className="h-9 px-4 bg-primary hover:bg-primary/90 shadow-md transition-all hover:scale-105">
                  <a href={project.caseStudyUrl} target="_blank" rel="noopener noreferrer" data-testid={`button-case-study-${project.id}`}>
...
export default function IMieiProgetti() {
  const [activeTab, setActiveTab] = useState("all");
  const [searchTerm, setSearchTerm] = useState("");

  // SEO Performance monitoring
  useSEOPerformance('progetti');

  // Fetch all projects (public endpoint to get all published projects)
  ...
  return (
    <>
      <SEOHead 
        title="I Nostri Progetti - Portfolio di Successi Digitali"
        description="Scopri i progetti che hanno trasformato il business dei nostri clienti. Portfolio completo con case study, risultati raggiunti e tecnologie utilizzate."
        keywords={['portfolio progetti', 'case study', 'risultati clienti', 'progetti marketing', 'sviluppo web']}
        type="website"
        url="/progetti"
      />
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto container-padding text-center">
          <div className="space-y-6">
            ...
            <h1 className="text-responsive-xl font-bold leading-[0.9] tracking-tight max-w-4xl mx-auto" data-testid="text-page-title">
              I Miei
            ...
            <p className="text-responsive-md text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Scopri i progetti e le partnership che hanno trasformato il business dei nostri clienti.
              Ogni progetto racconta una storia di successo, innovazione e crescita digitale.
            </p>
            ...
            <div className="flex items-center justify-center gap-8 pt-8">
              <div className="text-center">
                <div className="flex items-center justify-center gap-2 text-primary mb-1">
                  ...
                  <span className="text-2xl font-bold">{allProjectsData?.total || 0}</span>
                </div>
              ...
              <div className="text-center">
                <div className="flex items-center justify-center gap-2 text-primary mb-1">
                  ...
                  <span className="text-2xl font-bold">{featuredProjects?.length || 0}</span>
                </div>
                <p className="text-sm text-muted-foreground">In Evidenza</p>
              </div>
            </div>
              ...
              <TabsContent value={activeTab} className="mt-8">
                <div className="flex items-center justify-between mb-8">
                  <h2 className="text-xl font-semibold">
                    {activeTab === "all" && "Tutti i Progetti"}
                    {activeTab === "featured" && "Progetti in Evidenza"}
                    {activeTab === "development" && "Progetti di Sviluppo"}
                    {activeTab === "marketing" && "Progetti di Marketing"}
                    {activeTab === "consulting" && "Progetti di Consulenza"}
                    {activeTab === "projects" && "Solo Progetti"}
                    {activeTab === "partnerships" && "Partnership"}
                  </h2>
